...
export default function PhilosophyProjectExperimentPage() {
  return (
      ...
      <main className="flex-1">
        <section className="relative">
          ...
          <div className="container relative px-4 py-16 md:py-24 md:px-6">
            <Link href="/experiments" className="inline-flex items-center text-sm font-medium text-indigo-600 mb-6">
            ...
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
              ...
              <div className="flex justify-center">
                <div className="relative h-[300px] w-full max-w-[500px] overflow-hidden rounded-xl bg-gradient-to-br from-indigo-100 to-indigo-200/20 shadow-lg hover:shadow-xl transition-all duration-300 hover:shadow-indigo-200/20">
          ...
          <div className="container px-4 md:px-6">
            <div className="mx-auto max-w-3xl space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-lg border overflow-hidden hover:shadow-lg transition-all duration-300">
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="md:col-span-1 bg-indigo-100/20 p-6 flex items-center justify-center">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-lg border p-6 mb-4 bg-indigo-100/10 hover:shadow-lg transition-all duration-300">
