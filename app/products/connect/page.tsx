      ...
      <main className="flex-1">
        <section className="relative">
          ...
          <div className="container relative px-4 py-16 md:py-24 md:px-6">
            <Link href="/products" className="inline-flex items-center text-sm font-medium text-blue-600 mb-6">
            ...
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
              <div className="space-y-4">
                ...
                <p className="text-xl text-neutral-600">
                  A revolutionary social media platform that prioritizes meaningful connections and authentic
                  conversations.
                </p>
              </div>
            </div>
            ...
            <div className="mx-auto max-w-3xl space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-lg text-neutral-600">
                  Connect is designed to foster genuine relationships and meaningful interactions in the digital space.
                  We believe social media should bring people together, not drive them apart.
                </p>
              </div>
