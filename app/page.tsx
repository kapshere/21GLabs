      ...
      <main className="flex-1">
            ...
            <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
              <div className="space-y-6">
                ...
                <div className="flex flex-col gap-2 min-[400px]:flex-row">
                  <Link href="/products">
                    <Button className="inline-flex h-10 items-center justify-center rounded-md bg-brand-blue px-8 text-sm font-medium text-white shadow transition-colors hover:bg-brand-blue/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-neutral-950 disabled:pointer-events-none disabled:opacity-50">
                      Explore Products
        ...
        <section className="w-full bg-brand-blue-light/30 py-16 md:py-24">
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto grid max-w-5xl gap-8 pt-12 md:grid-cols-2 lg:grid-cols-4">
              ...
              <div className="group relative overflow-hidden rounded-lg border bg-white shadow-sm transition-all hover:shadow-md">
                <div className="p-6">
                  ...
                  <Link
                    href="/products/philosophy-project"
                    className="mt-4 inline-flex items-center text-sm font-medium text-brand-blue hover:underline"
                  >
                    Learn more
                    <ChevronRight className="ml-1 h-4 w-4" />
